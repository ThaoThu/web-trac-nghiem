...
CKEDITOR.editorConfig = function( config ) {
	...
	// config.uiColor = '#AADC6E';
        config.filebrowserBrowseUrl = '/public/elfinder/for_ckeditor.html?mode=file';
        config.filebrowserImageBrowseUrl = '/demock/public/elfinder/for_ckeditor.html?mode=image';
